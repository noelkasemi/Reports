...
import YesterdayDataFetcher from './YesterdayDataFetcher';
...
const AdDataTable = ({ yesterdayDate }) => {
  ...
  return (
    <div className="p-4">
      ...
      <YesterdayDataFetcher onDataFetched={handleYesterdayDataFetched} />
      {data && yesterdayData ? (
        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
          ...
          <tbody>
            <tr>
              ...
              <td className="px-6 py-3 border-b border-gray-300 text-center">16</td>
            </tr>
            <tr>
              ...
              <td className="px-6 py-3 border-b border-gray-300 text-center">2</td>
            </tr>
          </tbody>
        </table>
      ) : (
